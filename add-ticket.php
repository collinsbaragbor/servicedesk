      ...
      <form action="newcode.php" method="POST">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="user_email" class="form-control" value="<?php echo $_SESSION['email']; ?>" placeholder="Enter User Email">
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">History 
        <button type="button" class="btn btn-primary" name="addoffensebtn" data-toggle="modal" data-target="#addticketprofile">
            Add Issue 
        </button>
    </h6>
  </div>
